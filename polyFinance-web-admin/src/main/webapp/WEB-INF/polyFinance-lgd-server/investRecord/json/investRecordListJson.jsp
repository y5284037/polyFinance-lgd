...
<json:object escapeXml="false">
    ...
    <json:array name="data">
        <c:forEach items="${investRecordList}" var="investRecord">
            <json:object>
                ...
                <json:property name="productInterestAmountLine"
                               value="${investRecord.productInterestAmountLine}"></json:property>
                ...
                <json:property name="intercreditorAgreement"
                               value="${investRecord.intercreditorAgreement}"></json:property>
